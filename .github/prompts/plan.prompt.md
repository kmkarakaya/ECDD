...
# Instructions
1.  **Analyze the Project Definition**: Read `artifacts/project_definition.md` to understand the full scope, goals, and technical constraints.
2.  **Analyze the Template**: Read `templates/template_simple_workpackage.md`. This defines the structure you MUST use for each item in your list.
...
# Constraints
-   **Strict Template Adherence**: You must use the exact markdown structure from `templates/template_simple_workpackage.md` for each WP entry.
