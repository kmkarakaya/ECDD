...
1. **Gather Project Context**:
   * Review `artifacts/project_definition.md` for project overview, tech stack, architecture, and scope.
   * Review `artifacts/workpackage_list.md` for high-level roadmap and feature breakdown.
   * **Action**: Read any available detailed specs in `artifacts/workpackage_*.md` to gather more context if they exist.
