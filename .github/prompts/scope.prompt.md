...
output_file: ".github/prompts/copilot-instructions.md"
---
# Context
...
1. **Gather Project Context**: Read all available artifacts in `.artifacts` folder such as:
...
2. **Structure the Instructions File**: Create `.github/prompts/copilot-instructions.md` with these sections:
...
5. **Generate Output**: Create `.github/prompts/copilot-instructions.md`.
...
6. **Completion Statement**: After creating the file, state clearly: "✅ GitHub Copilot instructions file is complete! The file `.github/prompts/copilot-instructions.md` has been created. Coding agents in VS Code will now follow project-specific guidelines."
